package com.bottomtab.jgraph.models;
...
public class Jchart implements Cloneable {
    ...
    private float mWidth;//기둥 폭
    private float mHeight;//도면 조정 y 폴리라인
    private PointF mStart = new PointF();//矩形左下角起点
    private float mMidX;//x 중간점
    private int mColor = -1;
    private float mNum; //현재수치
    private float mMax; //전체 데이터
    private float percent;//회계
    private String textMsg; //정보 표시
    private String mXmsg; //가로좌표정보
